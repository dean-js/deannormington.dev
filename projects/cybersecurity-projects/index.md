...
This page tracks my hands-on cybersecurity project work as it happens - a mix of TryHackMe progress, home lab exercises, and other practical tasks that build on the theory from my NCFE studies.
...
Using an old laptop and computer as a home lab server, I've been practising setting up and defending small environments safely, running virtual machines across different Linux distributions to get comfortable outside of a single OS.
...
I plan to keep this page updated with specific write-ups as I complete rooms, labs, and other cybersecurity tasks, showcasing the practical understanding behind the NCFE coursework.
